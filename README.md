...
| `singleDynamicListHeight`  | This parameter is the option to set the height of the dynamic ListView                                                                                                                                           |
...
| `onChangeSingleText`       | This parameter is the call back to get the character during the typing (real time)                                                                                                                               |
